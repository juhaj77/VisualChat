# VisualChat
Channel members can edit the shared view. Workspace has draggable working area. Notes can be moved. ___The workspace opens when a channel is selected___. Functionality can be found in context menus. 
### try app
